...
import { LayoutDashboard, Users, FileText, X, ChevronLeft, ChevronRight, Calendar } from 'lucide-react';
...
// REORDERED: Dashboard, Manage Users, Semester Config, All Syllabi
const navItems = [
  ...
  { label: 'Semester Config', icon: <Calendar className="h-5 w-5" />, path: '/admin/semesters' },
  { label: 'All Syllabi', icon: <FileText className="h-5 w-5" />, path: '/admin/syllabi' },
];
